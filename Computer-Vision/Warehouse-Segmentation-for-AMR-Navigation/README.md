...
The segmentation model enables robots to:

- Detect warehouse racks
- Detect storage boxes
- Understand warehouse layouts
- Improve obstacle awareness
- Support autonomous navigation and path planning

The project serves as a perception module that can be integrated with ROS2-based AMR systems and autonomous warehouse robots.
